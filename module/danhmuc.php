<?php
			...
			$sql_cate = mysqli_query($con, "select * from tb_loaisanpham,tb_sp where tb_loaisanpham.loaisp_id=tb_sp.loaisp_id and
			tb_sp.loaisp_id='$id' order by tb_sp.sanpham_id desc");
			$sql_category = mysqli_query($con, "select * from tb_loaisanpham,tb_sp where tb_loaisanpham.loaisp_id=tb_sp.loaisp_id and
			tb_sp.loaisp_id='$id' order by tb_sp.sanpham_id desc");
			$row_title= mysqli_fetch_array($sql_category);
			$title = $row_title['tenloai_sp'];
