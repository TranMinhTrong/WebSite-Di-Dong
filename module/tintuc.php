		...
		<div class="agile_inner_breadcrumb">
			<div class="container">
				<ul class="w3_short">
                    ...
                    <?php
                        $sql_tendanhmuc= mysqli_query($con,"select * from tb_tintuc where tin_id='$id_danhmuc'");
	...
	<div class="welcome py-sm-5 py-4">
		<div class="container py-xl-4 py-lg-2">
			...
			<h3 class="tittle-w3l text-center mb-lg-5 mb-sm-4 mb-3">
				<span><?php echo $row_danhmuc['tendanhmuc'] ?></span></h3>
			<!-- //tittle heading -->
			<?php
			$sql_baiviet=mysqli_query($con,"select * from tb_tintuc,tb_baiviet where tb_tintuc.tin_id=tb_baiviet.tintuc_id and
			tb_tintuc.tin_id='$id_danhmuc'");
